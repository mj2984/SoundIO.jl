...
shared_data = SampleArray(zeros(Sample{2, Q0f15}, Int(buffer_atom_time * sampling_frequency), total_buffer_atoms), (sampling_frequency,nothing)) # Pre allocate the array for buffering.
